...
async def do_broadcast(bot, message=None, message_text: str = "") -> tuple[int, int]:
    """
    Broadcast to all users.
    If message object provided — forward it (supports text, photo, video, etc).
    Otherwise sends message_text as plain text.
