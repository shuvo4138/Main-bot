...
COUNTRY_LANGUAGE: dict[str, str] = {
    # English
    "1": "English", "44": "English", "61": "English", "64": "English",
    "27": "English", "233": "English", "234": "English", "254": "English",
    "255": "English", "256": "English", "260": "English", "263": "English",
    "353": "English", "65": "English", "63": "English",
    # French
    "33": "French", "221": "French", "223": "French", "224": "French",
    "225": "French", "226": "French", "227": "French", "228": "French",
    "229": "French", "230": "French", "235": "French", "236": "French",
    "237": "French", "241": "French", "242": "French", "243": "French",
    "245": "French", "257": "French", "258": "French", "261": "French",
    "269": "French", "32": "French", "352": "French",
    # Arabic
    "212": "Arabic", "213": "Arabic", "216": "Arabic", "218": "Arabic",
    "20": "Arabic", "249": "Arabic", "966": "Arabic", "971": "Arabic",
    "974": "Arabic", "965": "Arabic", "973": "Arabic", "968": "Arabic",
    "967": "Arabic", "962": "Arabic", "961": "Arabic", "963": "Arabic",
    "964": "Arabic", "970": "Arabic", "222": "Arabic",
    # Russian
    "7": "Russian", "380": "Ukrainian", "375": "Belarusian",
    "374": "Armenian", "994": "Azerbaijani", "995": "Georgian",
    "992": "Tajik", "993": "Turkmen", "996": "Kyrgyz", "998": "Uzbek",
    "373": "Moldovan", "381": "Serbian", "385": "Croatian",
    "387": "Bosnian", "389": "Macedonian", "359": "Bulgarian",
    # Spanish
    "34": "Spanish", "52": "Spanish", "54": "Spanish", "56": "Spanish",
    "57": "Spanish", "58": "Spanish", "51": "Spanish", "593": "Spanish",
    "591": "Spanish", "595": "Spanish", "598": "Spanish", "502": "Spanish",
    "503": "Spanish", "504": "Spanish", "505": "Spanish", "506": "Spanish",
    "507": "Spanish", "53": "Spanish",
    # Portuguese
    "55": "Portuguese", "351": "Portuguese", "244": "Portuguese",
    "238": "Portuguese", "239": "Portuguese", "245": "Portuguese",
    # Hindi/Indian
    "91": "Hindi",
    # Bengali
    "880": "Bengali",
    # Chinese
    "86": "Chinese", "852": "Chinese", "853": "Chinese", "886": "Chinese",
    # Japanese
    "81": "Japanese",
    # Korean
    "82": "Korean",
    ...
    "30": "Greek",
    # Czech/Slovak
    "420": "Czech", "421": "Slovak",
    # Hungarian
    "36": "Hungarian",
    # Swedish/Nordic
    "46": "Swedish", "47": "Norwegian", "45": "Danish", "358": "Finnish",
    # Other
    "94": "Sinhala", "977": "Nepali", "975": "Dzongkha",
    "976": "Mongolian", "856": "Lao", "855": "Khmer",
}


def get_language_by_code(dial_code: str) -> str:
    """
    Return language name from dial code.
    Falls back to 'English' if not found.
    """
    for length in (3, 2, 1):
        if len(dial_code) >= length:
            c = dial_code[:length]
...
def get_language_from_number(number: str) -> str:
    """
    Detect language from a phone number string.
    Strips non-digits, tries 3→2→1 digit prefix.
    """
    import re as _re
    clean = _re.sub(r'\D', '', str(number)).lstrip('0')
    return get_language_by_code(clean)


def get_language_from_range(range_id: str) -> str:
    """
    Detect language from a range string like '22898XXX'.
    Strips trailing X's then matches dial code.
    """
    import re as _re
    clean = _re.sub(r'X+$', '', str(range_id).upper().strip())
    return get_language_by_code(clean)


def detect_language_from_sms(text: str) -> str:
    """
    Detect language from SMS text using script/keyword detection.
    ...
    if any(c in 'àáâãèéêìíòóôõùúýăđơưạặầẩậắẵắẹếềệỉịọộốổỗớờởỡợụứừửữựỳỵ' for c in text.lower()):
        return "Vietnamese"
    # French keywords
    text_lower = text.lower()
    french_words = ['votre', 'voici', 'est votre', 'de confirmation', 'ne partagez', 'utiliser', 'valider']
    if any(w in text_lower for w in french_words):
        return "French"
    # Spanish keywords
    spanish_words = ['su código', 'tu código', 'código de', 'no compartas', 'verificación']
    if any(w in text_lower for w in spanish_words):
        return "Spanish"
    # Portuguese keywords
    portuguese_words = ['seu código', 'teu código', 'não compartilhe', 'verificação']
    if any(w in text_lower for w in portuguese_words):
        return "Portuguese"
    # German keywords
    german_words = ['dein code', 'ihr code', 'nicht teilen', 'bestätigung']
    if any(w in text_lower for w in german_words):
        return "German"
    # Indonesian/Malay
    indo_words = ['kode', 'jangan bagikan', 'verifikasi']
    if any(w in text_lower for w in indo_words):
        return "Indonesian"
